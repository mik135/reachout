...
<div class="flex flex-col gap-5 cursor-pointer container">
    <div class="w-full md:min-h-52 md:max-h-52 overflow-hidden rounded-xl shadow-2xl"><img loading="lazy" src={"./" + img} alt={title} class={img.includes("ROWDAY") ? "hidden md:block object-cover w-full h-full" : "w-full h-full object-cover"}></div>
