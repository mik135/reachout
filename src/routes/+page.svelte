...
<main>
	<div class="px-3 py-5">
		<section class="mb-10">
			<div class="h-[17rem] bg-blue-800 flex items-center rounded-2xl">
				<img src={banner} alt="banner">
			</div>
			<div class="mt-5">
				<div class="grid grid-cols-2 gap-3">
					<button class="btn bg-gradient-watch text-white border-none font-bold shadow-md">
	...
	<div class="px-3 py-5 grid gap-10">
