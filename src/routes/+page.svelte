<script>
	...
	let firstGrid = cardInfo.slice(0, 3)
	let secondGrid = cardInfo.slice(3, 6)
	let thirdGrid = cardInfo.slice(6, 9)
	let fourthGrid = cardInfo.slice(9, 11)
...
<main>
	<div class="px-3 py-5">
		<section class="mb-10 min-[500px]:mb-24">
			<div class="h-[17rem] min-[500px]:h-auto bg-blue-800 flex items-center rounded-2xl">
